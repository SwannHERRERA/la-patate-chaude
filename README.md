# Projet Rust: _la Patate Chaude_ <br> Architecture des Logiciels - 4<sup>ème</sup> année - ESGI
...
- Employer une stratégie de jeu pour maximiser les _chances_ de victoires d'un joueur
...
- Réussir à faire _crasher_ le serveur de référence

NB: Pour les _Bonus_, vous avez le droit d'employer des modules (_aka_ crates) additionnels.
...
Tous les messages se passent sur un flux TCP qui doit rester ouvert pendant toute la durée de la partie (et fermer _
proprement_ en fin de partie).
